    ...
    Home: [
        {
            id: 1,
            title: 'Welcome',
            body: 'Welcome to the Administration Console.',
        },
        {
            id: 2,
            title: 'Analytics',
            body:
                'You can monitor the behavior of your applications from the Analytics dashboard. Navigate there from the menu on the right.',
        },
    ],
    Analytics: [
        {
